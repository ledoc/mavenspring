	...
	<div class="container">
		...
		<div class="content">
			<div class="page-header">
				<h1>
					Gestion client <small>Liste de tous les clients</small>
				</h1>
			</div>
			<div class="row">
				<div class="span3">
					...
					<ul class="nav pills stacked">
						<li><a href="saveclient.do">Saisir</a></li>
					...
					<table class="table table-bordered table-striped">
						...
						<c:forEach items="${clients}" var="c" >
							<tr>
								...
								<td>${c.name}</td>
								<td>${c.adresse}</td>
								<td><security:authorize ifAllGranted="ROLE_ADMIN"><a class="btn danger" href="removeclient.do?id=${c.id}">Supprimer</a></security:authorize> <a
									class="btn success" href="saveclient.do?id=${c.id}">Modifier</a><a
									class="btn success" href="listcommandeparclient.do?clientId=${c.id}">Commandes</a></td>
							</tr>
						</c:forEach>	
						</tbody>
