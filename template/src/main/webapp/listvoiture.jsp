...
<body>
	...
	<c:if test="${not empty voiture }">
	Voiture Enregistrée : ${voiture.marque}
	</c:if>
		...
		<div class="container">
			...
			<div class="content">
				<div class="page-header">
					<h1>
						Gestion voiture <small>Liste de toutes les voitures</small>
					</h1>
				</div>
				<div class="row">
					<div class="span3">
								...
								<c:forEach items="${voitures}" var="v">
									<tr>
										...
										<td><security:authorize ifAllGranted="ROLE_ADMIN">
												<a class="btn danger" href="removevoiture.do?id=${v.id}">Supprimer</a>
											</security:authorize> <a class="btn success" href="savevoiture.do?id=${v.id}">Modifier</a></td>
									</tr>
								</c:forEach>
							</tbody>
