	...
	<div class="container">
		...
		<div class="content">
			<div class="page-header">
				<h1>
					Gestion employe <small>Enregistrer un nouvel employe</small>
				</h1>
			</div>
			<div class="row">
				<div class="span3">
					...
					<ul class="nav pills stacked">
						...
						<li><a href="listemploye.do">Lister</a></li>
						<li><a href="#">Rechercher</a></li>
					</ul>
				</div>
				<div class="span7">

					<form:form action="saveemploye.do" method="post" commandName="employe" class="form-horizontal">
