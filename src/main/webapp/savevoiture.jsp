		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="span7">
					...
					<form:form action="savevoiture.do" method="post" commandName="voiture" class="form-horizontal">
						<form:hidden path="id"/>
						<div class="alert alert-error">Le champ marque est
							obligatoire</div>
						...
						<fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="input01">Marque</label>
								<div class="controls">
									<form:input type="text" class="input-xlarge" id="input01" path="marque"/>
								</div>
							</div>

							<div class="control-group">
								<label class="control-label" for="input01">Modele</label>
								<div class="controls">
									<form:input type="text" class="input-xlarge" id="input01" path="modele"/>
								</div>
							</div>

							<div class="control-group">
								<label class="control-label" for="input01">Date mise en
									cirulation</label>
								<div class="controls">
									<form:input type="text" class="input-xlarge" id="input01" path="version"/>
								</div>
							</div>
